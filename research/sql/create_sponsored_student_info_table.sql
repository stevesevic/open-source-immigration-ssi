...
ALTER TABLE [dbo].[sponsoredStudentInformation]  WITH CHECK ADD  CONSTRAINT [FK_sponsoredStudentInformation_jbInternational] FOREIGN KEY([idnumber])
REFERENCES [dbo].[jbInternational] ([idnumber])
GO

ALTER TABLE [dbo].[sponsoredStudentInformation] CHECK CONSTRAINT [FK_sponsoredStudentInformation_jbInternational]
GO
